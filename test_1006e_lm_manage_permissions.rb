...
class LMUserManageAccess < Base
  ...
  def test_line_manger_manage_permisssions
    ...
    puts 'delete the employees sickness record'
    puts 'try to delete'
    puts 'manage 121 meetings'
    puts 'manage objectives'
    puts 'manage deliverables'
    puts 'manage employees job details'
    puts 'manage employees remunerations package (salary/additional payments/benefits/bank details)'
    puts 'manage any notes made on the employee'
    puts 'manage id documentation'
