...
class LoginExtension < Base
  ...
  def login_negative_carry_over_holiday_employee
    driver.find_element(id: 'email-input').send_keys settings[:staging][:negative_carry_over_holiday_email]
    sleep 1
    driver.find_element(name: 'password').send_keys settings[:staging][:login_password]
    sleep 1
    driver.find_element(css: 'form button[type=submit]').click
  ...
  def login_setup_acc_finance_user
  ...
  def login_rota_employee
    driver.find_element(id: 'email-input').send_keys settings[:staging][:rota_employee_email]
    sleep 0.5
    driver.find_element(name: 'password').send_keys settings[:staging][:login_password]
    sleep 0.5
    driver.find_element(css: 'form button[type=submit]').click
  ...
  def login_rota_line_manager
    driver.find_element(id: 'email-input').send_keys settings[:staging][:rota_line_manager_email]
    sleep 0.5
    driver.find_element(name: 'password').send_keys settings[:staging][:login_password]
    sleep 0.5
    driver.find_element(css: 'form button[type=submit]').click
  ...
  def login_holiday_year_end
    driver.find_element(id: 'email-input').send_keys settings[:staging][:edit_year_admin_email]
    sleep 0.5
    driver.find_element(name: 'password').send_keys settings[:staging][:login_password]
    sleep 0.5
    driver.find_element(css: 'form button[type=submit]').click
  ...
  def login_hourly_holiday_employee
    driver.find_element(id: 'email-input').send_keys settings[:staging][:hourly_holiday_employee_email]
    sleep 0.5
    driver.find_element(name: 'password').send_keys settings[:staging][:login_password]
    sleep 0.5
    driver.find_element(css: 'form button[type=submit]').click
