...
class SignUpExtension < Base
    def sign_up
        ...
        driver.find_element(id:'account-name').send_keys "RegressionAccount1"
        #driver.find_element(id:'account-name').send_keys "RegressionAccount #{TestRefExtension.test_reference_admin_signup}"
