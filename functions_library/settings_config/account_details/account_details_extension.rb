...
class AccountDetailsExtension < Base
  ...
  def company_details_data_entry_edit_positive
    ...
    driver.find_element(id: 'account_subscription_attributes_charity_number')
          .send_keys '4354129'
    driver.find_element(id: 'account_subscription_attributes_registered_charity_name').clear
    driver.find_element(id: 'account_subscription_attributes_registered_charity_name')
          .send_keys 'Regression Account Ltd'
    ...
    # company logo
    # driver.find_element(id: 'account_logo')
    #       .send_keys "" #need to find an image to upload and reference it here to the file
    ...
    # driver.find_element(id: 'account_referred_by_code')
    #       .sendkeys "" #need to find some data from a referral code withing staging
    # submit info
    # scroll page
