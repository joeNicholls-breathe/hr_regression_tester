...
class CompanyHolidaysExtension < Base
  def company_holiday_add
    ...
    driver.find_element(id: '#company_holiday_day_on_react').send_keys todays_date_string_slash
  ...
  def company_holiday_edit
    ...
    driver.find_element(id: 'company_holiday_name').send_keys "Edited Company Test Holiday #{todays_date_string}"
    driver.find_element(id: '#company_holiday_day_on_react').clear
    driver.find_element(id: '#company_holiday_day_on_react').send_keys one_month_date_string
    driver.find_element(id: 'company_holiday_half').click
