...
class CalendarSubscriptionExtension < Base
  def calendar_central_setting_on
    ...
    driver.find_element(xpath: '/html/body/div[3]/div/section/form/div/div/p/input').click
    # see page check
  end
  ...
  def amend_calendar_revert_settings
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/span').click
