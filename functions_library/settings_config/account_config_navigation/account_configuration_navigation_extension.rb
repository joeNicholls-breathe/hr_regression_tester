...
class NavigationAroundAccountConfiguration < Base
  def navigate_to_company_details
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[1]/div[1]/a[1]').click
  end

  def navigate_back_to_settings_breadcrumb
    driver.find_element(css: 'body > div.hr-main-container > div > section > div.breadcrumb.mb-2 > a').click
  end

  def navigate_back_to_settings_breadcrumb_email_notification
    driver.find_element(xpath: '/html/body/div[4]/div/section/div/div/div/a').click
  end

  def navigate_to_modules_chargable
    driver.find_element(xpath: '//*[@id="tabs-0"]/li[1]/a').click
  end

  def navigate_to_modules_free
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[1]/div[1]/a[2]').click
  end

  def navigate_to_picklist
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[1]/div[1]/a[3]').click
  end
  ...
  def navigate_to_email_notifications
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[1]/div[1]/a[4]').click
  end
  ...
  def navigate_to_woking_patterns
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[1]/a[1]').click
  end

  def navigate_to_holiday_allowances
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[1]/a[2]').click
  end

  def navigate_to_holiday_years
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[1]/a[3]').click
  end

  def navigate_to_company_holidays
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[1]/a[4]').click
  end

  def navigate_to_company_blackout
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[1]/a[5]').click
  end

  def navigate_to_api_setup
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[2]/a[1]').click
  end

  def navigate_to_calendar_subscriptions
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[2]/a[2]').click
  end

  def navigate_to_rota_cloud
    driver.find_element(xpath: '/html/body/div[3]/div/section/div[2]/div[2]/div[2]/a[3]').click
  end
end
