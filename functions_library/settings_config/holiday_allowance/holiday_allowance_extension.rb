...
class AccountHolidayAllowanceExtension < Base
  ...
  def holiday_allowances_add
    ...
    driver.find_element(id: 'holiday_allowance_title').send_keys "Regression Test holiday allowance" + todays_date_string
  ...
  def holiday_allowances_select_default
    ...
    driver.find_element(css: '#DataTables_Table_0 > tbody > tr.even > td.actions > a:nth-child(1) > svg').click
    driver.find_element(id: 'holiday_allowance_title').send_keys "Edit holiday allowance" + todays_date_string
  ...
  def holiday_allowance_show_inactive
    driver.find_element(css: 'body > section.content.container.p-4 > form:nth-child(5) > div > div > div.row.m-0 > div > div > div > input').click
    driver.find_element(css: 'body > section.content.container.p-4 > form:nth-child(5) > div > div > div.form-group.buttons > input').click
  end
