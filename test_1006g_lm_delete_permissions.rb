...
class LMUserDeleteAccess < Base
  ...
  def test_line_delete_permisssions
    ...
    puts 'try to delete'
    puts 'delete 121 meetings'
    puts 'delete objectives'
    puts 'delete deliverables'
    puts 'delete employees job details'
    puts 'delete employees remunerations package (salary/additional payments/benefits/bank details)'
    puts 'delete any notes made on the employee'
    puts 'delete id documentation'
